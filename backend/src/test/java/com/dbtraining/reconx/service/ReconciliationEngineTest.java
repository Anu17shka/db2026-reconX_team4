...
class ReconciliationEngineTest {
    ...
    void testReconcile_priceTolerance_withinThreshold(String diff) {
        ...
        EquityTrade internal = equity("EQU-20260603-0002", basePrice.toPlainString(), "10");
        EquityTrade external = equity("EQU-20260603-0002", basePrice.add(new BigDecimal(diff)).toPlainString(), "10");
