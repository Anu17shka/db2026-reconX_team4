...
public class ReconciliationEngine {
    ...
    /**
     * Explicit executor for CompletableFuture tasks.
     * Avoids JVM common ForkJoinPool.
     */
    private final Executor reconExecutor =
     ...
     * TICKET-ADV037
     *
     * Reconcile each counterparty concurrently,
